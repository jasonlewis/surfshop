...
/***/ function(module, exports) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.default={authenticated:false,attempt:function attempt(context,credentials,redirect){context.$http.post('auth',credentials).then(this.success,this.failed);},success:function success(response){console.log('success',response.status);},failed:function failed(response){console.log('failed',response.status);}};
